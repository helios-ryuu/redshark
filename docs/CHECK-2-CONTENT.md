# CHECK-2-CONTENT.md — Tiêu chuẩn nghiệm thu: Ý tưởng, Công việc, Bình luận

WBS tham chiếu: [WBS.md](WBS.md) — kiểm thử cho nhóm công việc `4.0`.

> **Tiêu chuẩn nghiệm thu bắt buộc cho PLAN-2-CONTENT.**
> Tất cả 24 TC phải đạt ✅ trước khi PLAN-2 được tính hoàn thành.
